...
class SequenceDataset_joint(Dataset):
    '''
    ...
    def __init__(self, df, window_size, stride,
        ...
        for data_id in X_copy['id'].unique():
            ...
            for j in idxs:
                ...
                prob_1_fm = fm_sub.iloc[j + self.window_size - 1:j + self.window_size]
                data_tuple = (sample_copy, label_copy, data_id, prob_1_fm)
    ...
    def __getitem__(self, idx):  # get the samples when used rather than load them at once.
        ...
        return sample, label, data_id, fm_label
